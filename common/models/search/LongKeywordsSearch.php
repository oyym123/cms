...
class LongKeywordsSearch extends LongKeywords
{
    ...
    {
        return [
            [['id', 'key_id', 'key_search_num', 'status', 'from'], 'integer'],
            [['m_down_name', 'm_seach_name', 'm_related_name', 'pc_down_name', 'pc_search_name', 'pc_related_name', 'keywords', 'remark', 'url', 'created_at', 'updated_at'], 'safe'],
        ];
    }
    ...
    public function search($params)
    {
        ...
        $query->andFilterWhere(['like', 'm_down_name', $this->m_down_name])
            ->andFilterWhere(['like', 'm_seach_name', $this->m_seach_name])
