...
/**
 * WhiteArticleSearch represents the model behind the search form of `common\models\WhiteArticle`.
 */
class WhiteArticleSearch extends WhiteArticle
{
    /**
     * {@inheritdoc}
     */
